...
public class Lotto{
    ...
    // ifuser guess is matching to lottery number check array is getting updated with matched number ==> line 126
    public void compute(){
    ...
    // check ifplayer is entitled to prize for each set of numbers as per project requirement
        switch(count1){
            case 3:win1=" - €125";
                break;
